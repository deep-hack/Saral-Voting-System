...
<label><?php echo $row['candidates_name'];?> </label>
    ...
    ?>
    <input type="submit" name="vote_caste"class="btn btn-success"value="Dear Voter Caste Your Vote">
...
if(isset($_POST['vote_caste'])){
  ...
  if($exe1->num_rows>0){
    echo "You Have Already !! Casted Your Vote Against Election:  ".$elections_name;
  }
  else{
    ...
    if($run){
      ...
      if($exe){
          echo "Dear Voter You Have Voted Successfully";
      }
      else{
