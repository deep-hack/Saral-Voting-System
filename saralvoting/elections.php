...
<label for="exampleInputEmail">Your Unique Voter ID</label>
                        <input type="text" class="form-control" name="user_id" id="exampleInputEmail" placeholder="Enter Your Unique Voter ID" required>
</div>
                        <div class="form-group">
...
$_SESSION['user_id_generated']=$user_id_generated=$row['user_id_generated'];
    ...
    echo "Error! Your Unique Voter ID or Password Invalid!";
  }
}
?>