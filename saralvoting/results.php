...
<div class="container">
    <div class="col-md-6 col-md-offset-3">
        <h3 class="text text-info text-center">Election Results </h3>
        <p class="tetx text-danger">In This Section Elections Results Will Be Displayed Which Are Closed Or Finished</p>
<form method="post" action="">
 <div class="form-group">
 <select class="form-control" name="elections_name">
       <option selected="selected"value="">Select Elections</option> 
       <?php 
       $current_ts=time();
...
<?php
    ...
    <td>
        ...
        ?>
<tr>
        <td colspan="4">SORRY:) Records! Not Found</td>
         </tr>
        <?php
    }
